import pytest
from config.china_stag_config import ChinaStagIrrigationManagerConfig
...
_fixtures = create_service_fixtures(ChinaStagIrrigationManagerConfig, api_customizer=_customize_api)
