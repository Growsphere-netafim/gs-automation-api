import pytest
from config.china_stag_config import ChinaStagIrrigationConfig
...
_fixtures = create_service_fixtures(ChinaStagIrrigationConfig, api_customizer=_customize_api)
