import pytest
from config.china_stag_config import ChinaStagCommandsManagerConfig
...
_fixtures = create_service_fixtures(ChinaStagCommandsManagerConfig, api_customizer=_customize_api)
