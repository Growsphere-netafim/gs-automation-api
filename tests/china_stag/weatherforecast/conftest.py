import pytest
from config.china_stag_config import ChinaStagWeatherForecastConfig
...
_fixtures = create_service_fixtures(ChinaStagWeatherForecastConfig, api_customizer=_customize_api)
