import pytest
from config.china_prod_config import ChinaProdCommandsManagerConfig
...
_fixtures = create_service_fixtures(ChinaProdCommandsManagerConfig, api_customizer=_customize_api)
