import pytest
from config.china_prod_config import ChinaProdWeatherForecastConfig
...
_fixtures = create_service_fixtures(ChinaProdWeatherForecastConfig, api_customizer=_customize_api)
