...
class TestDevices:
    ...
    @pytest.mark.flaky
    # TODO: GET /api/v1/devices/serial/{sn} returns 404 for all devices found in QA1.
    # To fix: find a device whose serialNumber is resolvable via /api/v1/devices/serial/{sn}
    ...
    @pytest.mark.flaky
    # TODO: device certificate endpoint returns 404 for the configured device in QA1.
    # To fix: find a deviceReferenceId that has a cert via GET /api/v1/devices/{id}/cert
    ...
    @pytest.mark.flaky
    # TODO: device private key endpoint returns 404 for the configured device in QA1.
    # To fix: find a deviceReferenceId that has a prkey via GET /api/v1/devices/{id}/prkey
    ...
    @pytest.mark.flaky
    # TODO: device assignability endpoint returns 409 in QA1 (farm assignment conflict).
    # Infrastructure/state issue — no code fix possible without environment changes.
