...
class TestUsers:
    ...
    @pytest.mark.flaky
    # TODO: impersonationToken is ephemeral — requires a valid impersonation token from QA1.
    # To fix: generate an impersonation token for a QA1 user before running this test.
