...
class TestCultures:
    ...
    def test_get_cultures_list(self, csapi_service):
        ...
        if isinstance(resp_json, dict) and "totalRecords" in resp_json:
            ...
            pass  # It's a list, valid

    @pytest.mark.flaky
    # TODO: GET /api/v1/cultures/{appId}/{id} returns 404 for all cultures listed in QA1.
    # To fix: find a culture code that exists via GET /api/v1/cultures/GsMobileApp/{code}
